...
export const eras: Era[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        tech: ["Next.js", "React 19", "TypeScript", "Algolia", "Stripe", "PayPal", "RDS (MySQL)", "Vercel"],
      ...
      },
      {
        ...
        tech: ["Next.js", "TypeScript", "RDS (MySQL)", "DynamoDB", "EventBridge", "Stripe Terminal", "AWS IoT", "Algolia", "ShipEngine", "Vercel"],
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tech: ["Next.js", "React 19", "TypeScript", "Algolia", "Stripe", "PayPal", "ShipEngine", "RDS (MySQL)", "Vercel"],
  ...
  },
  {
    ...
    tech: ["Next.js", "TypeScript", "RDS (MySQL)", "DynamoDB", "EventBridge", "Stripe Terminal", "AWS IoT MQTT", "Algolia", "ShipEngine", "PostGrid", "Anthropic API", "S3", "Vercel"],
    note: "Private / internal tool",
    image: { src: "/screenshots/fh-pos.png", alt: "Family Hardware point-of-sale register — live cart, category browser, and tender panel" },
    metrics: [
