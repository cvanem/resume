    ...
    items: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Designed the discount engine from scratch: cart- and line-level discounts across percent, fixed, and preset amounts, per-customer tier pricing (percent-off-retail or cost-plus margin), and SKU-targeted coupon codes with use limits and expiries — governed by product-level non-discountable flags, per-line caps that can't drive a price below zero, and hard blocks against stacking manual discounts on tier or employee pricing, all correct to the cent.",
