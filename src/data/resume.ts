    ...
    items: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Owned deployment and scale — Dockerized .NET Core services with PostgreSQL, plus the release process and scaling plan.",
        ],
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Owned deployment and scalability — Dockerized .NET Core services with PostgreSQL, plus the release process and scaling plan.",
    ],
    tech: ["React", "Redux", "Material UI", "SignalR", ".NET Core", "PostgreSQL", "Docker", "Cordova", "PWA / offline-first"],
    note: "Site no longer active",
    images: greenlinkShots,
